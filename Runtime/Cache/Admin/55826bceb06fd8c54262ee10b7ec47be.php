...
<script>
    ...
    <div class="clearfix">
        <div class="col-xs-8 pd0">
            ...
            <button class="btn" data-role="csv" data-url="<?php echo U('admin/action/csv');?>">
                <?php echo L("_EXPORT_CSV_");?>
            </button>
        </div>
    ...
    <div class="modal fade" id="select">
        <div class="modal-dialog modal-sm" style="margin-top: 198px;width: 528px;">
            <div class="modal-content" style="height: 298px">
                ...
                <div class="modal-body">
                    <form class="ajax-form" method="post" action="<?php echo U('admin/action/actionLog');?>">
                        ...
                        <div class="col-xs-5">
                            <select name="select">
                                <option></option>
                                <?php if(is_array($action_list)): $i = 0; $__LIST__ = $action_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
