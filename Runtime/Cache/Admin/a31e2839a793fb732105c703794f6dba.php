			...
			<form id="form" method="post" class="form-horizontal doc-modal-form">
				...
				<div id="tab1" class="tab-pane in tab1">
					<div class="form-item cf">
						<label class="item-label"><?php echo L("_ORDER_NO_");?></label>
						<div class="controls">
							<span><?php echo ($info['order_no']); ?></span>
						</div>
					</div>
					<div class="form-item cf">
						<label class="item-label"><?php echo L("_ORDER_QUESTION_");?></label>
						<div class="controls">
							<span><?php echo ($questres['title']); ?></span>
						</div>
					</div>
					<div class="form-item cf">
						<label class="item-label"><?php echo L("_ORDER_MONEY_");?></label>
						<div class="controls">
							<span><?php echo ($info['pay_money']); ?></span>
						</div>
					</div>
					<div class="form-item cf">
						<label class="item-label"><?php echo L("_ORDER_STATUS_");?></label>
						<div class="controls">
							<span><?php echo ($statusstr); ?></span>
						</div>
					</div>
					<div class="form-item cf">
						<label class="item-label"><?php echo L("_ORDER_CREATETIME_");?></label>
						<div class="controls">
							<span><?php echo ($info['createtime']); ?></span>
						</div>
					</div>

					<div class="form-item cf">
						<label class="item-label"><?php echo L("_ORDER_ENDTIME_");?></label>
						<div class="controls">
							<span><?php echo ($info['endtime']); ?></span>
						</div>
					</div>

					<div class="form-item cf">
						<label class="item-label"><?php echo L("_ORDER_INVOICE_");?></label>
						<div class="controls">
							<span><?php echo ($info['invoice_no']); ?></span>
						</div>
					</div>
				</div>
